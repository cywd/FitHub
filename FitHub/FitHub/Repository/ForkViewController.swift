...
class ForkViewController: BaseViewController {
    ...
    func requestData() {
        ...
        NetworkManager.loadCommonRepos(withUrl: url, page: self.page, success: { (items) in
...
extension ForkViewController: UITableViewDataSource, UITableViewDelegate {
